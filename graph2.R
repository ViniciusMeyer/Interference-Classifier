...
dframe <- read.csv2("~/interference/r/PDP2020/graph2.csv", sep=",", header=T,dec=",")

pdf("~/interference/r/PDP2020/graph2.pdf", width=4, height=2)
ggplot(dframe,aes(x=factor(as.character(host), levels=c("8", "10", "12","16","24"))))+ 
  ...
  #scale_x_continuous(breaks = c(8,10,12,16,24))+
